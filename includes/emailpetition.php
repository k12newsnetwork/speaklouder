...
function dk_speakout_public_css_js( $posts ) {
	...
	if ( $shortcode_found ) {
		...
		switch( $theme ) {
			case 'default' :
				wp_enqueue_style( 'dk_speakout_css', plugins_url( '../css/theme-default.css', __FILE__ ) );
				break;
			case 'basic' :
				wp_enqueue_style( 'dk_speakout_css', plugins_url( '../css/theme-basic.css', __FILE__ ) );
				break;
			case 'none' :
		...
		wp_enqueue_script( 'dk_speakout_js', plugins_url( '../js/public.js', __FILE__ ), array( 'jquery' ) );
